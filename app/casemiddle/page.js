...
export default function Home() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={6} breadcrumbTitle="Case study">
                <div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-10">
                                    <div className="serviceauthior-area p-0">
                                        ...
                                        <h1 className="font-lora font-40 lineh-50 weight-600 color-29 margin-b20 margin-t28">Case study
                                            </h1>
                                        <p className="font-ks font-16 lineh-26 weight-500 color-30 margin-b20">Our team working on it</p>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4">
                                    <div className="single-portfolio singlecase">
                                        ...
                                        <div className="portfolio-textarea">
                                            <h1 className="font-24 weight-600 font-outfit lineh-24 color-17 margin-b14"><Link href="/casemiddle" className="color-17">Case study</Link></h1>
                                            <p className="font-outfit weight-400 color-17 lineh-26 font-16">The landing page should clearly
                                                to the tax communicate the unique value and benefits. </p>
                                            <div className="portfolio-visible-textarea margin-t">
                                                <p className="font-outfit weight-400 color-17 lineh-26 font-16">Discuss how the consultant
