...
export default function Home() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={13} footerStyle={6} breadcrumbTitle="Technical Support/ Managed Services">
                <div> 
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-10">
                                    <div className="serviceauthior-area p-0">
                                        ...
                                        <h1 className="font-lora font-40 lineh-50 weight-600 color-29 margin-b20 margin-t28">Technical Support/ Managed Services</h1>


                                        <p className="font-ks font-16 lineh-26 weight-500 color-30 margin-b20">Welcome to a world of seamless operations and peace of mind with our top-notch Technical Support and Managed Services. Our commitment is to ensure that your business runs smoothly, without interruption, and with optimal performance. Our experienced and highly skilled technical support team is dedicated to providing prompt and effective assistance, tackling any issues that may arise with precision and expertise. We understand the critical nature of technology in today's business environment, and our support services are designed to keep your systems up and running at all times. In addition to technical support, our Managed Services offer a proactive and strategic approach to IT management. We take the reins in overseeing your IT infrastructure, monitoring performance, and implementing preventative measures to address potential challenges before they impact your business.  </p>
                                        <p className="font-ks font-16 lineh-26 weight-500 color-30">Our comprehensive suite of managed services covers everything from system updates and security patches to data backup and recovery. With our proactive management, you can focus on your core business activities, confident that your IT systems are in capable hands. Partner with us for Technical Support and Managed Services that go beyond traditional support, offering you peace of mind and the freedom to concentrate on your business priorities. We're here to ensure that your technology works for you, not the other way around.  </p>
