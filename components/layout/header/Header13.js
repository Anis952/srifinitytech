...
export default function Header13({ scroll, isMobileMenu, handleMobileMenu }) {
    return (
        <>
                                                        ...
                                                        <div className="row">
                                                            <div className="col-lg-3">
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index1" className="theme-btn11 font-f-3"><span className="font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index1" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                            ...
                                                            <div className="col-lg-3">
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index7" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index2" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index3" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index3" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index8" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index4" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index2" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index5" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index5" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index6" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index4" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index7" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>a&gt;
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index6" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index8" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index9" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index9" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index10" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index10" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index11" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index11" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index12" className="theme-btn11 font-f-3 font-ks font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                        <Link href="/single-index12" className="theme-btn11 font-ks font-16 lineh-16 weight-600 color margin-t d-inline-block">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                                                </div>
